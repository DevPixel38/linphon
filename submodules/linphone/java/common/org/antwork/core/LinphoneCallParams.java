...
import org.antwork.core.LinphoneCore.MediaDirection;
import org.antwork.core.LinphoneCore.MediaEncryption;
import org.antwork.core.LinphoneCore.StreamType;
/**
...
public interface LinphoneCallParams {
	...
	**/
	 ...
	 * @param privacy_mask a or'd int of values defined in interface {@link org.antwork.core.Privacy}
	 */
	void setPrivacy(int privacy_mask);
	
	/**
	 * Get the privacy mask requested for this call.
	 * @return the privacy mask as defined in interface {@link org.antwork.core.Privacy}
	 */
	int getPrivacy();
