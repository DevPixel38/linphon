...
public class LinphoneActivity extends LinphoneGenericActivity implements OnClickListener, ContactPicked, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private LinearLayout sideMenuContent;
    private RelativeLayout quitLayout, defaultAccount;
...
//		changeCurrentFragment(FragmentsAvailable.DIALER, extras);
    ...
    public void initSideMenu() {
        ...
        sideMenuContent = (LinearLayout) findViewById(R.id.side_menu_content);
        ...
        findViewById(R.id.side_menu_logout).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
