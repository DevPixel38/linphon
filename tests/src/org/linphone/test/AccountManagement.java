...
import org.antwork.FragmentsAvailable;
...
public class AccountManagement extends SampleTest {
	...
	public void testAEditAccount() {
		...
		solo.clickOnText(aContext.getString(org.antwork.R.string.pref_username));
	...
	public void testBDeleteAccount() {
		...
		solo.clickLongOnText(aContext.getString(org.antwork.R.string.pref_delete_account));
	...
	public void testCDisableAccount() {
		...
		solo.clickLongOnText(aContext.getString(org.antwork.R.string.pref_disable_account));
