...
public class ConferenceAndMultiCall extends SampleTest {
	...
	public void testCRemoveOneFromConference() {
		...
		solo.clickOnView(solo.getView(org.antwork.R.id.conference_pause));
	...
	public void testFAddNewCallAndCancelIt() {
		...
		solo.clickOnView(solo.getView(org.antwork.R.id.add_call));
	...
	public void testHIncomingCallWhileInCallAndDecline() {
		...
		solo.sleep(2000);
		try {
			LinphoneTestManager.getLc(2).invite("sip:" + iContext.getString(org.antwork.test.R.string.account_linphone_login) + "@" + iContext.getString(org.antwork.test.R.string.account_linphone_domain));
	...
	private void startConference() {
		...
		solo.clickOnView(solo.getView(org.antwork.R.id.options));
		solo.clickOnView(solo.getView(org.antwork.R.id.conference));
		solo.sleep(1000);
