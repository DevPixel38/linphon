...
import org.antwork.CallIncomingActivity;
import org.antwork.CallOutgoingActivity;
...
import org.antwork.core.PayloadType;
...
public class CallsVideo extends SampleTest {
	...
	public void testAInit() {
		...
		solo.sleep(500);
		solo.clickOnText(aContext.getString(org.antwork.R.string.pref_video_enable_title));
		solo.clickOnText(aContext.getString(org.antwork.R.string.pref_video_initiate_call_with_video_title));
		solo.clickOnText(aContext.getString(org.antwork.R.string.pref_video_automatically_accept_video_title));
		solo.sleep(500);
		solo.goBack();
	...
	public void testBOutgoingCallWithDefaultConfig() {
		...
		solo.clickOnView(solo.getView(org.antwork.R.id.video_frame));
	...
	public void testCDTMFRFC2833InPCMUCall() {
		...
		solo.clickOnView(solo.getView(org.antwork.R.id.dialer));
		solo.clickOnView(solo.getView(org.antwork.R.id.Digit3));
		solo.clickOnView(solo.getView(org.antwork.R.id.dialer));
	...
	public void testHOutgoingCallDeclined() {
		...
		solo.sleep(1500);
		Assert.assertTrue(solo.searchText(aContext.getString(org.antwork.R.string.error_call_declined)));
	...
	public void testIIncomingAudioCall() {
		...
		solo.sleep(2000);
		try {
			LinphoneTestManager.getLc().invite("sip:" + iContext.getString(org.antwork.test.R.string.account_linphone_login) + "@" + iContext.getString(org.antwork.test.R.string.account_linphone_domain));
		...
		solo.sleep(1000);
		solo.clickOnView(solo.getView(org.antwork.R.id.accept));
...
//	}
	...
	public void testKSelfPauseResumeCall() {
		...
		solo.clickOnView(solo.getView(org.antwork.R.id.video_frame));
		solo.clickOnView(solo.getView(org.antwork.R.id.pause));
		solo.sleep(1000);

		waitForCallPaused(LinphoneManager.getLc().getCalls()[0]);
		solo.clickOnView(solo.getView(org.antwork.R.id.video_frame));
		solo.clickOnView(solo.getView(org.antwork.R.id.call_pause));
		solo.sleep(1000);
	...
	public void testMSwitchOffVideoInCall() {
		...
		Assert.assertTrue(solo.getView(org.antwork.R.id.video).isEnabled());
		solo.clickOnView(solo.getView(org.antwork.R.id.video_frame));
		solo.clickOnView(solo.getView(org.antwork.R.id.video));
		solo.sleep(1000);
	...
	private void goToSettings() {
		...
		solo.clickOnText(aContext.getString(org.antwork.R.string.menu_settings));
	}
	...
	private void goToAudioCodecsSettings() {
		...
		solo.clickOnText(aContext.getString(org.antwork.R.string.pref_audio_title));
		solo.sleep(500);
	}
	...
	private void goToVideoCodecsSettings() {
		...
		if (solo.searchText(aContext.getString(org.antwork.R.string.pref_video_title), 2)) // Needed in case pref_video_enable_title contains pref_video
			solo.clickOnText(aContext.getString(org.antwork.R.string.pref_video_title), 2);
		else
			solo.clickOnText(aContext.getString(org.antwork.R.string.pref_video_title));
		solo.sleep(500);
	}
	...
	private void disableAllEnabledVideoCodecs() {
		...
		if (isVideoCodecEnabled("VP8")) {
			solo.clickOnText(aContext.getString(org.antwork.R.string.pref_video_codec_vp8_title));
			solo.sleep(500);
		}
				
		if (isVideoCodecEnabled("H264")) {
			solo.clickOnText(aContext.getString(org.antwork.R.string.pref_video_codec_h264_title));
			solo.sleep(500);
		}
				
		if (isVideoCodecEnabled("MP4V-ES")) {
			solo.clickOnText(aContext.getString(org.antwork.R.string.pref_video_codec_mpeg4_title));
			solo.sleep(500);
		}
	}
